...
if (mysqli_num_rows($result) > 0) {
  while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo '
    <div class="card mx-auto" style="width: 30%; padding: 5px; magin-bottom: 10px;">
      <div class="media">
        <img class="mr-3" src="'.$picpath['picpath'].'" style="max-width: 75px; max-height: 75px; border-radius: 50%;">
        <div class="media-body">
          <h4 class="mt-0">'.$row['uname'].'</h5>
  ...
  echo '<h5 style="text-align: center;">No reviews, yet! Be the first one to review!</h5>';
}
